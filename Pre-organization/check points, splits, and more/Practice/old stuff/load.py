...
if __name__ == "__main__":
    ...
    parser.add_argument("audio_path", help="Folder that contains wav files to convert")
    ...
    if os.path.isdir(audio_path):
        ...
        raise TypeError("The audio_path file you specified isn't appropiate for this operation")
